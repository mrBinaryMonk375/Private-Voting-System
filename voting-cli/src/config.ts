/**
 * Private Voting System — CLI Configuration
 *
 * Defines network-specific configurations for connecting to Midnight networks.
 * The CLI supports: standalone (local), preview (testnet), and preprod (testnet).
 */
