...
export var ElectionState;
(function (ElectionState) {
  ElectionState[ElectionState['REGISTRATION'] = 0] = 'REGISTRATION';
  ElectionState[ElectionState['OPEN'] = 1] = 'OPEN';
  ElectionState[ElectionState['CLOSED'] = 2] = 'CLOSED';
})(ElectionState || (ElectionState = {}));

export var VoteChoice;
(function (VoteChoice) {
  VoteChoice[VoteChoice['CANDIDATE_A'] = 0] = 'CANDIDATE_A';
  VoteChoice[VoteChoice['CANDIDATE_B'] = 1] = 'CANDIDATE_B';
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      registerVoter: (...args_1) => {
        ...
        const voterPubKey_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerVoter',
                                     'argument 1 (as invoked from Typescript)',
                                     'voting.compact line 77 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(voterPubKey_0.buffer instanceof ArrayBuffer && voterPubKey_0.BYTES_PER_ELEMENT === 1 && voterPubKey_0.length === 32)) {
          __compactRuntime.typeError('registerVoter',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(voterPubKey_0),
      ...
      openElection: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`openElection: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('openElection',
                                     'argument 1 (as invoked from Typescript)',
                                     'voting.compact line 85 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._openElection_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      ...
      castVote: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('castVote',
                                     'argument 1 (as invoked from Typescript)',
                                     'voting.compact line 111 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(choice_0) === 'number' && choice_0 >= 0 && choice_0 <= 1)) {
          __compactRuntime.typeError('castVote',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'voting.compact line 111 char 1',
                                     'Enum<VoteChoice, CANDIDATE_A, CANDIDATE_B>',
                                     choice_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        const partialProofData = {
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(2n),
                                                                                              alignment: _descriptor_11.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(title_0),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _registerVoter_0(context, partialProofData, voterPubKey_0) {
    const callerKey_0 = this._publicKey_0(this._localSecretKey_0(context,
                                                                 partialProofData));
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_11.toValue(3n),
                                                                                                                   alignment: _descriptor_11.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(voterPubKey_0),
                                                                                                                                               alignment: _descriptor_1.alignment() }).encode() } },
                                                                                        'member',
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
  ...
  _openElection_0(context, partialProofData) {
    const callerKey_0 = this._publicKey_0(this._localSecretKey_0(context,
                                                                 partialProofData));
    __compactRuntime.assert(this._equal_1(callerKey_0,
                                          _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    partialProofData,
                                                                                                    [
                                                                                                     { dup: { n: 0 } },
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value)),
                            'Only the election admin can open the election');
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
  ...
  _closeElection_0(context, partialProofData) {
    const callerKey_0 = this._publicKey_0(this._localSecretKey_0(context,
                                                                 partialProofData));
    __compactRuntime.assert(this._equal_2(callerKey_0,
                                          _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    partialProofData,
                                                                                                    [
                                                                                                     { dup: { n: 0 } },
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value)),
                            'Only the election admin can close the election');
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
  ...
  _castVote_0(context, partialProofData, choice_0) {
    ...
    const voterKey_0 = this._publicKey_0(this._localSecretKey_0(context,
                                                                partialProofData));
    const publicVoterKey_0 = voterKey_0;
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_11.toValue(3n),
                                                                                                                  alignment: _descriptor_11.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(publicVoterKey_0),
                                                                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                                                                       'member',
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
