...
export enum ElectionState { REGISTRATION = 0, OPEN = 1, CLOSED = 2 }

export enum VoteChoice { CANDIDATE_A = 0, CANDIDATE_B = 1 }
...
export type ImpureCircuits<PS> = {
  registerVoter(context: __compactRuntime.CircuitContext<PS>,
                voterPubKey_0: Uint8Array): __compactRuntime.CircuitResults<PS, []>;
  ...
  castVote(context: __compactRuntime.CircuitContext<PS>, choice_0: VoteChoice): __compactRuntime.CircuitResults<PS, []>;
}
